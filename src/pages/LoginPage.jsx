...
import { useAuth, DEFAULT_ACCOUNTS } from '../context/AuthContext.jsx';
...
export default function LoginPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      navigate(user.role === 'franchise' ? '/dashboard' : '/');
    } catch (err) {
        ...
        <div className="auth-form-wrap">
          ...
          <div className="demo-banner">
            <div className="demo-banner-top">
              <div className="demo-banner-icon"><i className={`ti ${role==='franchise'?'ti-building-store':'ti-user-check'}`}></i></div>
              <div className="demo-banner-text">
                <div className="demo-banner-title">{role==='franchise'?'Franchise Demo Account':'Customer Demo Account'}</div>
            ...
            <div className="demo-creds">
              <div className="demo-cred-row">
                ...
                <span className="demo-cred-value">{demo.email}</span>
              </div>
              <div className="demo-cred-row">
                <span className="demo-cred-label"><i className="ti ti-lock"></i> Password</span>
                <span className="demo-cred-value">{demo.password}</span>
              </div>
            </div>
          ...
          {role==='franchise' && (
            <div className="franchise-notice"><i className="ti ti-info-circle"></i>
              <span>Franchise partners get listing management, lead tracking &amp; analytics dashboards.</span>
            </div>
          )}
          ...
          <div className="auth-footer-link" style={{marginTop:16}}>Don't have an account? <Link to="/signup">Create one free</Link></div>
          <div className="auth-footer-link" style={{marginTop:8}}>Franchise partner? <Link to="/signup?role=franchise">Apply here →</Link></div>
        </div>
      </div>
