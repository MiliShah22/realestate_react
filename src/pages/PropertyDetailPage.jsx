            ...
            {enquiryDone ? (
              ...
              <form onSubmit={sendEnquiry}>
                ...
                <div className="contact-btns">
                  ...
                  {/* builderPhone not in schema — removed */}
                  {false && (
                    <a href="#" className="btn-whatsapp" style={{textDecoration:'none',textAlign:'center',display:'flex',alignItems:'center',justifyContent:'center',gap:8}}>
                      <i className="ti ti-phone"></i> Call Now
                    </a>
                  )}
                </div>
              </form>
